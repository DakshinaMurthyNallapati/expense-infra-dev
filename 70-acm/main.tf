#Certificate creation through Amazon Certificate Manager(ACM)
...
# Domain(DNS) validation by creating records in route53
...
#Certificate validation done after creating records in route 53
